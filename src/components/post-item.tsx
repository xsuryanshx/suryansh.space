  ...
  return (
    ...
    >
      <Link
        href={`/blog/${post.slug}`}
        prefetch={true}
        className="text-neutral-900 dark:text-gray-200 hover:text-accent dark:hover:text-accent transition-colors duration-200"
      >
        {post.metadata.title.toLowerCase()}
      </Link>
      <div className="flex items-center text-sm text-neutral-600 dark:text-gray-400 shrink-0">
        <span>
